...
result_path = joinpath(@__DIR__, "../../../result/sph/lid_driven_cavity/2d_re100_compulsive")
...
with_theme(theme_latexfonts()) do
    ...
    s = scatter!(axes, x, y, color = vel, colormap = :roma, markersize = 7, nan_color = :gray, marker = :rect)
